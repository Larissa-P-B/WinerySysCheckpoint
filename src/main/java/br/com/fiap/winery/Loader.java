...
//        Endpoint.publish("http://localhost:8085/WineStockService", wineStock);
        ...
        WineStockServiceImplementation wineStock =
                new WineStockServiceImplementation();

        WineWarningServiceImplementation wineWarning =
                new WineWarningServiceImplementation();
